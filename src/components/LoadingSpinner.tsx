...
export const LoadingSpinner: React.FC = () => (
  <div role="status" className="flex justify-center items-center p-4">
    <svg
      aria-hidden="true"
      className="inline w-10 h-10 text-gray-600 animate-spin dark:text-gray-300"
      viewBox="0 0 100 101"
      fill="none"
    ...
    >
      <path
        d="M100 50.5908C100 78.2051 77.6142 100.591 50 
           ...
           100 22.9766 100 50.5908ZM9.08197 50.5908C9.08197 
           73.1895 27.4013 91.5088 50 91.5088C72.5987 91.5088 
           90.918 73.1895 90.918 50.5908C90.918 27.992 72.5987 
           9.67268 50 9.67268C27.4013 9.67268 9.08197 27.992 
           9.08197 50.5908Z"
        fill="currentColor"
      />
      <path
